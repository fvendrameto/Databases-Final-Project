errors = {'PK_ENDERECO' : 'ID conflitante',
	...
	'"ENDERECO"."RUA"' : 'Rua é um campo obrigatório',
	'"ENDERECO"."NUMERO"' : 'Número é um campo obrigatório',
	'"ENDERECO"."CIDADE"' : 'Cidade é um campo obrigatório',
	'"DADOS_BANCARIOS"."AGENCIA"' : 'Agência é um campo obrigatório',
	'"DADOS_BANCARIOS"."CONTA"' : 'Conta é um campo obrigatório',
	'"FESTA"."GERENTE"' : 'Gerente é um campo obrigatório',
	'"FESTA"."CLIENTE"' : 'Cliente é um campo obrigatório',
	'"FESTA"."CASA_FESTA"' : 'Casa de festa é um campo obrigatório',
	'"FUNCIONARIO"."NOME"' : 'Nome é um campo obrigatório',
	'"CLIENTE"."NOME"' : 'Nome é um campo obrigatório',
	'"CASA_FESTA"."NOME"' : 'Nome é um campo obrigatório',
	'"FORNECEDOR"."NOME"' : 'Nome é um campo obrigatório',
	'"BEBIDA"."NOME"' : 'Nome é um campo obrigatório',
}
