...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gerente_check = QtWidgets.QCheckBox(self.widget_2)
        self.gerente_check.setChecked(True)
        self.gerente_check.setObjectName("gerente_check")
        self.gridLayout_6.addWidget(self.gerente_check, 1, 0, 1, 1)
        self.garcom_check = QtWidgets.QCheckBox(self.widget_2)
        self.garcom_check.setChecked(True)
        self.garcom_check.setObjectName("garcom_check")
        self.gridLayout_6.addWidget(self.garcom_check, 1, 1, 1, 1)
        self.operador_check = QtWidgets.QCheckBox(self.widget_2)
        self.operador_check.setChecked(True)
        self.operador_check.setObjectName("operador_check")
        self.gridLayout_6.addWidget(self.operador_check, 1, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.quantidade_label, 0, 0, 1, 1)
        self.quantidade_spinBox = QtWidgets.QSpinBox(self.bebidas)
        self.quantidade_spinBox.setObjectName("quantidade_spinBox")
        self.gridLayout_9.addWidget(self.quantidade_spinBox, 1, 0, 1, 1)
