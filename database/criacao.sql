...
CREATE TABLE FORNECEDOR(
	...
	DADOS_BANCARIOS NUMBER(10) NOT NULL,
...
CREATE TABLE FUNCIONARIO(
	...
	CONSTRAINT CK_FUNCIONARIO_CARGO CHECK (UPPER(CARGO) IN ('GARÇOM', 'GERENTE', 'BARTENDER', 'OPERADOR')),
...
CREATE TABLE CLIENTE(
	...
	CONSTRAINT CK_CLIENTE_TEL_MOVEL CHECK (TEL_MOVEL LIKE '(__)9____-____')
);
