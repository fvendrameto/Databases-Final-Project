CREATE TABLE DADOS_BANCARIOS(
	...
	TIPO_CONTA VARCHAR2(2) NOT NULL,
...
CREATE TABLE ENDERECO(
	...
	CONSTRAINT UQ_ENDERECO UNIQUE (RUA, CIDADE, ESTADO, NUMERO),
	CONSTRAINT CK_ENDERECO_CEP CHECK (CEP LIKE '_____-___')
);
...
CREATE TABLE FORNECEDOR(
	...
	DADOS_BANCARIOS NUMBER(5) NOT NULL,
...
CREATE TABLE FUNCIONARIO(
	...
	CONSTRAINT CK_FUNCIONARIO_CPF CHECK (CPF LIKE '___.___.___-__'),
	CONSTRAINT CK_FUNCIONARIO_CARGO CHECK (UPPER(CARGO) IN ('GARCOM', 'GERENTE', 'BARTENDER', 'OPERADOR')),
	CONSTRAINT CK_FUNCIONARIO_TEL_MOVEL CHECK (TEL_MOVEL LIKE '(__)%9____-____'),
	CONSTRAINT CK_FUNCIONARIO_TEL_FIXO CHECK (TEL_FIXO LIKE '(__)%____-____')
);
...
CREATE TABLE CLIENTE(
	...
	TEL_FIXO VARCHAR2(13),
	TEL_MOVEL VARCHAR2(14) NOT NULL,
	ENDERECO NUMBER(5) NOT NULL,

	CONSTRAINT PK_CLIENTE PRIMARY KEY (CPF),
	CONSTRAINT FK1_CLIENTE FOREIGN KEY (DADOS_BANCARIOS) REFERENCES DADOS_BANCARIOS(ID) ON DELETE CASCADE,
	CONSTRAINT FK2_CLIENTE FOREIGN KEY (ENDERECO) REFERENCES ENDERECO(ID) ON DELETE CASCADE,
	CONSTRAINT CK_CLIENTE_CPF CHECK (CPF LIKE '___.___.___-__'),
	CONSTRAINT CK_CLIENTE_TEL_FIXO CHECK (TEL_FIXO LIKE '(__)%____-____'),
	CONSTRAINT CK_CLIENTE_TEL_MOVEL CHECK (TEL_MOVEL LIKE '(__)%____-____')
);
...
CREATE TABLE CASA_FESTA(
	...
	CONSTRAINT FK_CASA_FESTA FOREIGN KEY (ENDERECO) REFERENCES ENDERECO(ID) ON DELETE CASCADE
);
...
CREATE TABLE FESTA(
	...
	PRECO NUMBER(8,2),
	CASA_FESTA VARCHAR2(75) NOT NULL,
	GERENTE VARCHAR2(14) NOT NULL,
	...
	CONSTRAINT FK3_FESTA FOREIGN KEY (GERENTE) REFERENCES FUNCIONARIO(CPF) ON DELETE CASCADE,
...
CREATE TABLE BARRACA_RASPADINHA(
	...
	CONSTRAINT FK2_BARRACA_RASPADINHA FOREIGN KEY (OPERADOR) REFERENCES FUNCIONARIO(CPF) ON DELETE CASCADE
);
...
CREATE TABLE ILHA_PERFORMANCE(
	...
	DATA DATE NOT NULL,
	NUMERO NUMBER(3) NOT NULL,
	BARTENDER VARCHAR2(14) NOT NULL,

	CONSTRAINT PK_ILHA_PERFORMANCE PRIMARY KEY (ID),
	CONSTRAINT UQ_ILHA_PERFORMANCE UNIQUE (CLIENTE, DATA, NUMERO),
	CONSTRAINT FK1_ILHA_PERFORMANCE FOREIGN KEY (CLIENTE, DATA) REFERENCES CASAMENTO(CLIENTE, DATA) ON DELETE CASCADE,
	CONSTRAINT FK2_ILHA_PERFORMANCE FOREIGN KEY (BARTENDER) REFERENCES FUNCIONARIO(CPF) ON DELETE CASCADE
);

CREATE TABLE GARCOM_FESTA(
	CLIENTE VARCHAR2(14) NOT NULL,
	DATA DATE NOT NULL,
	GARCOM VARCHAR2(14) NOT NULL,

	CONSTRAINT PK_GARCOM_FESTA PRIMARY KEY (CLIENTE, DATA, GARCOM),
	CONSTRAINT FK1_GARCOM_FESTA FOREIGN KEY (CLIENTE, DATA) REFERENCES FESTA(CLIENTE, DATA) ON DELETE CASCADE,
	CONSTRAINT FK2_GARCOM_FESTA FOREIGN KEY (GARCOM) REFERENCES FUNCIONARIO(CPF) ON DELETE CASCADE 
);
...
CREATE TABLE BEBIDA(
	...
	BANDEJA VARCHAR(1) NOT NULL,
	PRECO NUMBER(6,2) NOT NULL,

	CONSTRAINT PK_BEBIDA PRIMARY KEY (NOME, VOLUME),
	CONSTRAINT CK_BEBIDA CHECK (UPPER(BANDEJA) IN ('S','N'))
);
...
CREATE TABLE BEBIDAS_DRINK(
	...
	CONSTRAINT PK_BEBIDAS_DRINK PRIMARY KEY (DRINK, BEBIDA, VOLUME),
...
CREATE TABLE INGREDIENTES_DRINK(
	...
	CONSTRAINT PK_INGREDIENTES_DRINK PRIMARY KEY (DRINK, INGREDIENTE),
	CONSTRAINT FK1_INGREDIENTES_DRINK FOREIGN KEY (INGREDIENTE) REFERENCES INGREDIENTE(NOME) ON DELETE CASCADE,
...
CREATE TABLE INGREDIENTES_RASPADINHA(
	...
	CONSTRAINT FK1_INGREDIENTES_RASPADINHA FOREIGN KEY (RASPADINHA) REFERENCES RASPADINHA(SABOR) ON DELETE CASCADE,
...
CREATE TABLE RASPADINHA_BARRACA(
	...
	CONSTRAINT PK_RASPADINHA_BARRACA PRIMARY KEY (RASPADINHA, BARRACA),
	CONSTRAINT FK1_RASPADINHA_BARRACA FOREIGN KEY (RASPADINHA) REFERENCES RASPADINHA(SABOR) ON DELETE CASCADE,
...
CREATE TABLE VENDA_BEBIDA(
	...
	CONSTRAINT FK1_VENDA_BEBIDA FOREIGN KEY (FORNECEDOR) REFERENCES FORNECEDOR(CNPJ) ON DELETE CASCADE,
	CONSTRAINT FK2_VENDA_BEBIDA FOREIGN KEY (NOME, VOLUME) REFERENCES BEBIDA(NOME, VOLUME) ON DELETE CASCADE
);
...
CREATE TABLE VENDA_INGREDIENTES(
	...
	CONSTRAINT FK1_VENDA_INGREDIENTES FOREIGN KEY (FORNECEDOR) REFERENCES FORNECEDOR(CNPJ) ON DELETE CASCADE,
	CONSTRAINT FK2_VENDA_INGREDIENTES FOREIGN KEY (INGREDIENTE) REFERENCES INGREDIENTE(NOME) ON DELETE CASCADE
);
